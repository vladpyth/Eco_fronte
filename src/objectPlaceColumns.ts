...
export const OBJECT_COLUMNS: ObjectCol[] = [
  ...
  { key: "payer_indentification_number", label: "УНП", editable: true, multiline: true },
  { key: "__phones", label: "Телефон юр. лица", editable: false },
  { key: "__city", label: "Район", ref: "cities" },
  { key: "place_obj", label: "Местонахождение объекта", editable: true, multiline: true },
  { key: "__phones_owner", label: "Телефон объекта", editable: false },
  ...
  { key: "__around", label: "Окружающие здания", editable: false },
  { key: "__natural", label: "Природоохранные здания", editable: false },
